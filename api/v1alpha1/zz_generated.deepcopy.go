...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ObservatoriumApiSpec) DeepCopyInto(out *ObservatoriumApiSpec) {
	*out = *in
	if in.Replicas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObservatoriumApiSpec.
func (in *ObservatoriumApiSpec) DeepCopy() *ObservatoriumApiSpec {
	if in == nil {
		return nil
	}
	out := new(ObservatoriumApiSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ObservatoriumSpec) DeepCopyInto(out *ObservatoriumSpec) {
	*out = *in
	...
	in.ObservatoriumApi.DeepCopyInto(&out.ObservatoriumApi)
}
