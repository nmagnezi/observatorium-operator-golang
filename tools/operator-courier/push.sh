...
QUAY_REPOSITORY="${QUAY_REPOSITORY:-observatorium-operator}"
PACKAGE_NAME="${PACKAGE_NAME:-observatorium-operator}"
SOURCE_DIR="${SOURCE_DIR:-/manifests}"
REPO_DIR="${QUAY_REPOSITORY:-observatorium-operator}"
NAMESPACE="${PACKAGE_NAME:-observatorium-operator}"
